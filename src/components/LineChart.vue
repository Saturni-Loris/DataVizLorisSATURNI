...
let chartOptions = reactive({
    ...
    plugins: {
        ...
        title: {
            ...
            text: "Consommation d'électricité et de gaz réunni dans le Grand-Est (tout secteurs confondus) en MWh en axe Y et années en X. Entre 2011 et 2021",
            // Police du texte
            font: {
                size: 16
            }
